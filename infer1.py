...
if __name__ == "__main__":
    ...
    '''
    python infer.py --model_file --input_path --inp_img_ext --output_path --label_file
    ...
    with detection_graph.as_default():
        with tf.Session() as sess:
            ...
            for in_img_path in tqdm(img_paths):
                ...
                out_img_path = os.path.join(output_path,img_name)
                # Read Image
